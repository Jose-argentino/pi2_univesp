...
-- Copiando dados para a tabela db_loja_roupa.tb_categoria: ~22 rows (aproximadamente)
...
-- Copiando dados para a tabela db_loja_roupa.tb_fornecedor: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela db_loja_roupa.tb_modelo: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela db_loja_roupa.tb_usuario: ~9 rows (aproximadamente)
